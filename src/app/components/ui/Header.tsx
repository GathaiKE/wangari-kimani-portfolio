...
const Header = ({data}:{data:Route[]}) => {
  ...
  return (
    <>
      ...
      <header 
        className={`fixed top-0 w-full z-50 py-5 backdrop-blur-md transition-all duration-300 ${
          isScrolled 
      ...
      <div
        ref={menuRef}
        className={`fixed top-0 left-0 h-full w-64 z-50 bg-surface dark:bg-surface-dark shadow-2xl transition-transform duration-300 ease-in-out ${
